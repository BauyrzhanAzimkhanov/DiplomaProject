...
urlpatterns = [
    ...
    path('courses/', CourseDetailAPIView.as_view()),

    path('lectures/', LectureListAPIView.as_view()),
    path('lectures/', LectureDetailAPIView.as_view()),

    path('absences/', AbsencesListAPIView.as_view()),
    path('absences/', AbsencesDetailAPIView.as_view()),

    path('lates/', LatesListAPIView.as_view()),
    path('lates/', LatesDetailAPIView.as_view()),

    path('marks/', MarksListAPIView.as_view()),
    path('marks/', MarksDetailAPIView.as_view()),
